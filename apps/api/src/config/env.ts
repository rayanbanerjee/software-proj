...
const envSchema = z.object({
  ...
  OPENROUTER_STREAM_MODEL: z.string().trim().min(1).optional(),
  OPENROUTER_PROVIDERS: z.string().trim().optional(),
  OPENROUTER_ALLOW_FALLBACKS: z.coerce.boolean().default(true),
